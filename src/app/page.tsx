            ...
            {/* ... Content same as before ... */}
             <div className="container mx-auto text-center">
                ...
                <motion.div
                    ...
                    <motion.div variants={fadeIn} className="p-6 bg-gray-800/50 rounded-lg border border-white/10 hover:border-purple-500/40 transition-colors duration-300 transform hover:scale-[1.03] hover:shadow-lg"> <h3 className="text-xl font-semibold mb-2 text-purple-400 flex items-center"><Layers size={20} className="mr-2"/>Layer 7 Protection</h3> <p className="text-gray-400 text-sm leading-relaxed">Inspects application traffic to filter bots and exploits, verifying legitimate players.</p> </motion.div>
                    <motion.div variants={fadeIn} className="p-6 bg-gray-800/50 rounded-lg border border-white/10 hover:border-blue-500/40 transition-colors duration-300 transform hover:scale-[1.03] hover:shadow-lg"> <h3 className="text-xl font-semibold mb-2 text-blue-400 flex items-center"><Route size={20} className="mr-2"/>Dynamic Assignment</h3> <p className="text-gray-400 text-sm leading-relaxed">Verified players are routed via API to the optimal proxy based on location and load.</p> </motion.div>
                    <motion.div variants={fadeIn} className="p-6 bg-gray-800/50 rounded-lg border border-white/10 hover:border-green-500/40 transition-colors duration-300 transform hover:scale-[1.03] hover:shadow-lg"> <h3 className="text-xl font-semibold mb-2 text-green-400 flex items-center"><Server size={20} className="mr-2"/>Distributed L4 Proxies</h3> <p className="text-gray-400 text-sm leading-relaxed">Our proxy network absorbs and mitigates high-volume network-level DDoS attacks.</p> </motion.div>
                </motion.div>
            </div>
      </section>
       ...
       <section id="caching" className="py-20 md:py-28 bg-gray-900 px-4 overflow-hidden">
            ...
            <div className="container mx-auto text-center">
                ...
                <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.2 }} variants={staggerContainer} className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto mt-16 md:mt-20">
                    <motion.div variants={fadeIn} className="p-6 bg-gray-800/50 rounded-lg border border-white/10 hover:border-orange-500/40 transition-colors duration-300 transform hover:scale-[1.03] hover:shadow-lg"> <h3 className="text-xl font-semibold mb-2 text-orange-400 flex items-center"><Cloud size={20} className="mr-2"/>Cloudflare CDN</h3> <p className="text-gray-400 text-sm leading-relaxed">Players download from Cloudflare's closest edge location for ultra-fast speeds worldwide.</p> </motion.div>
                     <motion.div variants={fadeIn} className="p-6 bg-gray-800/50 rounded-lg border border-white/10 hover:border-blue-500/40 transition-colors duration-300 transform hover:scale-[1.03] hover:shadow-lg"> <h3 className="text-xl font-semibold mb-2 text-blue-400 flex items-center"><Zap size={20} className="mr-2"/>Reduced Server Load</h3> <p className="text-gray-400 text-sm leading-relaxed">Caching dramatically reduces your server's bandwidth usage, freeing up resources for gameplay.</p> </motion.div>
                </motion.div>
           </div>
        </section>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.7, ease: 'easeOut' }} className="backdrop-blur-md bg-white/5 rounded-2xl border border-white/10 shadow-xl p-8 md:p-12 transform transition-all duration-500 hover:border-white/25 hover:shadow-2xl hover:shadow-indigo-500/10" >
              <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
                <div className="text-center md:text-left max-w-xl">
                  ...
                  <ul className="space-y-3 mb-8 text-gray-300 text-left text-sm md:text-base list-none pl-0"> <li className="flex items-center"> <CheckCircle2 className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" /> Multi-Layer L4 & L7 Mitigation </li> <li className="flex items-center"> <CheckCircle2 className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" /> Simple Integration & Dynamic Routing </li> <li className="flex items-center"> <CheckCircle2 className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" /> Cloudflare CDN for Optimized Content </li> <li className="flex items-center"> <CheckCircle2 className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" /> Recommended for OVHcloud Infrastructure </li> </ul>
                </div>
