            ...
            <div className="grid grid-cols-12 gap-4 md:gap-6">
                ...
                <div className={`flex flex-col text-white box-border outline-none shadow-lg transition-all duration-300 motion-reduce:transition-none rounded-xl relative overflow-hidden h-full border ${selectedPlan === 'shared' ? 'border-indigo-500 bg-indigo-900/20 ring-2 ring-indigo-500/50' : 'border-white/10 bg-gray-800/50 hover:bg-gray-800/70 hover:border-white/20'}`}>
                  <div className="p-4 md:p-6 flex-grow">
                    <div className="flex items-start sm:items-center gap-3 mb-4">
                      ...
                      <div> <div className="flex items-center"> <h3 className="text-sm font-bold mr-1 text-gray-100">{t('pricing.sharedPlanTitle')}</h3> </div> <p className="text-xs text-gray-400">{t('pricing.sharedPlanDesc')}</p> </div>
                    </div>
                    <div className="mb-4">
                      <span className="text-2xl font-bold">{sharedPricePerMonth.toFixed(1)}$ USD</span>
                      <span className="text-gray-400 ml-1 text-xs">{t('pricing.monthlySuffix')}</span>
                      <p className="text-xs text-gray-500 mt-0.5">{t('pricing.sharedPriceDesc')}</p>
                    </div>
                    <div className="space-y-2 mb-4">
                      <div className="flex items-start"> <Zap className="w-4 h-4 text-indigo-400 mt-0.5 mr-2 flex-shrink-0"/> <div> <p className="text-xs font-medium text-gray-200">{t('pricing.proxyPricingLabel')}</p> <p className="text-xs text-gray-400">{calculateSharedProxyPricePerHour(playerCount).toFixed(4)}$ {t('pricing.proxyPricingUnit')}</p> </div> </div>
                      <div className="flex items-start"> <Globe className="w-4 h-4 text-indigo-400 mt-0.5 mr-2 flex-shrink-0"/> <div> <p className="text-xs font-medium text-gray-200">{t('pricing.dynamicAssignmentLabel')}</p> <p className="text-xs text-gray-400">{t('pricing.dynamicAssignmentShared')}</p> </div> </div>
                      <div className="flex items-start"> <Shield className="w-4 h-4 text-indigo-400 mt-0.5 mr-2 flex-shrink-0"/> <div> <p className="text-xs font-medium text-gray-200">{t('pricing.protectionLabel')}</p> <p className="text-xs text-gray-400">{t('pricing.protectionShared')}</p> </div> </div>
                      <div className="flex items-start"> <Globe className="w-4 h-4 text-indigo-400 mt-0.5 mr-2 flex-shrink-0"/> <div> <p className="text-xs font-medium text-gray-200">{t('pricing.regionsLabel')}</p> <p className="text-xs text-gray-400">{t('pricing.regionsShared')}</p> </div> </div>
                       <div className="flex items-start"> <Server className="w-4 h-4 text-indigo-400 mt-0.5 mr-2 flex-shrink-0"/> <div> <p className="text-xs font-medium text-gray-200">{t('pricing.controlLabel')}</p> <p className="text-xs text-gray-400">{t('pricing.controlShared')}</p> </div> </div>
                    </div>
                  </div>
                  <button
              ...
              <motion.div variants={fadeIn} className="col-span-12 md:col-span-6">
                 <div className={`flex flex-col text-white box-border outline-none shadow-xl transition-all duration-300 motion-reduce:transition-none rounded-xl relative overflow-hidden h-full border ${selectedPlan === 'dedicated' ? 'border-indigo-500 bg-indigo-900/20 ring-2 ring-indigo-500/50 shadow-indigo-500/20' : 'border-white/10 bg-gray-800/50 hover:bg-gray-800/70 hover:border-white/20'}`}>
                   {recommendedPlan === 'dedicated' && ( <div className="absolute -right-11 top-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-10 py-0.5 rotate-45 text-xs font-bold shadow-md"> {t('pricing.recommendedTag')} </div> )}
                   <div className="p-4 md:p-6 flex-grow">
                     <div className="flex items-start sm:items-center gap-3 mb-4">
                      <div className="p-2 rounded-full bg-indigo-500/20 text-indigo-400 flex-shrink-0 mt-0.5 sm:mt-0"> <Zap size={16} /> </div>
                      <div> <div className="flex items-center"> <h3 className="text-sm font-bold mr-1 text-gray-100">{t('pricing.dedicatedPlanTitle')}</h3> </div> <p className="text-xs text-gray-400">{t('pricing.dedicatedPlanDesc')}</p> </div>
                    </div>
                    <div className="mb-4">
                    ...
                    <div className="space-y-2 mb-4">
                      <div className="flex items-start"> <Zap className="w-4 h-4 text-indigo-400 mt-0.5 mr-2 flex-shrink-0"/> <div> <p className="text-xs font-medium text-gray-200">{t('pricing.proxyPricingLabel')}</p> <p className="text-xs text-gray-400 font-bold">{calculateDedicatedProxyPricePerHour(playerCount).toFixed(4)}$ {t('pricing.proxyPricingUnit')}</p> </div> </div>
                      <div className="flex items-start"> <Globe className="w-4 h-4 text-indigo-400 mt-0.5 mr-2 flex-shrink-0"/> <div> <p className="text-xs font-medium text-gray-200">{t('pricing.dynamicAssignmentLabel')}</p> <p className="text-xs text-gray-400 font-bold">{t('pricing.dynamicAssignmentDedicated')}</p> </div> </div>
                      <div className="flex items-start"> <Shield className="w-4 h-4 text-indigo-400 mt-0.5 mr-2 flex-shrink-0"/> <div> <p className="text-xs font-medium text-gray-200">{t('pricing.protectionLabel')}</p> <p className="text-xs text-gray-400 font-bold">{t('pricing.protectionDedicated')}</p> </div> </div>
                       <div className="flex items-start"> <Globe className="w-4 h-4 text-indigo-400 mt-0.5 mr-2 flex-shrink-0"/> <div> <p className="text-xs font-medium text-gray-200">{t('pricing.regionsLabel')}</p> <p className="text-xs text-gray-400 font-bold">{t('pricing.regionsDedicated')}</p> </div> </div>
                      <div className="flex items-start"> <Server className="w-4 h-4 text-indigo-400 mt-0.5 mr-2 flex-shrink-0"/> <div> <p className="text-xs font-medium text-gray-200">{t('pricing.controlLabel')}</p> <p className="text-xs text-gray-400 font-bold">{t('pricing.controlDedicated')}</p> </div> </div>
                    </div>
                  </div>
                  <button
                    ...
                    <div className="text-center md:text-left flex-grow">
                      {showRecommendationWarning ? (
                          <p className="text-sm text-yellow-300">
                              ...
                              {/* ***** CORRECTED Trans COMPONENT USAGE ***** */}
                              <Trans
